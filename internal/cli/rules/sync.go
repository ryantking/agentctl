...
To troubleshoot:
  - Check that rules directory exists: agentctl rules list
  - Verify rule files are valid: agentctl rules show <rule-name>
  - Run with --dry-run to preview changes: agentctl rules sync --dry-run`)
			}
